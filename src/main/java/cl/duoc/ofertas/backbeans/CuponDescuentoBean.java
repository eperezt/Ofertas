        ...
        try {
            if (loginBean.getUsuarioSesionado().getPuntoList() != null && !loginBean.getUsuarioSesionado().getPuntoList().isEmpty()) {
                ...
                if (puntos >= 0 && puntos <= 100) {
                    ...
                    document.add(new Paragraph("Estimado(a): " + loginBean.getUsuarioSesionado().getConsumidor().getNombre() + " " + loginBean.getUsuarioSesionado().getConsumidor().getApellidopaterno() + " este cupón es válido por un 5% de descuento en Alimentos."));
                    ...
                    code128.setCode(String.valueOf(loginBean.getUsuarioSesionado().getConsumidor().getRut().intValue()));
                    PdfContentByte pdfContentByte = writer.getDirectContent();
                    Image barcode = code128.createImageWithBarcode(pdfContentByte, null, null);
                    ...
                    document.add(new Paragraph("Cupón de Descuento"));
                    document.add(new Paragraph(" "));
                    document.add(new Paragraph("Estimado(a): " + loginBean.getUsuarioSesionado().getConsumidor().getNombre() + " " + loginBean.getUsuarioSesionado().getConsumidor().getApellidopaterno() + " este cupón es válido por un 10% de descuento en Alimentos, Electrónica y Línea Blanca."));
                    ...
                    document.add(new Paragraph("Cupón de Descuento"));
                    document.add(new Paragraph(" "));
                    document.add(new Paragraph("Estimado(a): " + loginBean.getUsuarioSesionado().getConsumidor().getNombre() + " " + loginBean.getUsuarioSesionado().getConsumidor().getApellidopaterno() + " este cupón es válido por un 15% de descuento en Alimentos, Electrónica, Línea Blanca y Ropa."));
